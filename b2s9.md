...
object sincronizacionSensores extends App {
  ...
  val combined = sensor1.zipWith(sensor2)((temp1, temp2) => (temp1, temp2)).take(10)

  combined.subscribe { case (temp1, temp2) =>
    val difference = Math.abs(temp1 - temp2)
    println(s"Sensor1: $temp1°C, Sensor2: $temp2°C, Diferencia: $difference°C")
    if (difference > 5) {
